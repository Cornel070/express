...
<head>
    ...
    <title>Go Express Alliance - Create Parcel </title>
    <!-- Favicon icon -->
                    ...
                    <div class="col-xl-12 col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Add new parcel</h4>
                            </div>
                            <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="code" class="form-control" placeholder="13572454UG" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group">
                                                        <label class="text-label">Pickup Time*</label>
                                                        <input type="text" name="pickup_time" class="form-control" placeholder="12:00PM WAT" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group">
                                                        <label class="text-label">Sender Name*</label>
                                                        <input type="text" name="sender" class="form-control" placeholder="Konrad Mathews" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group">
                                                        <label class="text-label">Parcel Origin*</label>
                                                        <input type="text" name="origin" class="form-control" placeholder="Hong-Kong, China" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group">
                                                        <label class="text-label">Receiver Name*</label>
                                                        <input type="text" name="reciever" class="form-control" placeholder="Mrs. Sandra LaplaCa" required>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" name="reciever_phone" class="form-control" placeholder="(+1)408-657-9007" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 mb-4">
